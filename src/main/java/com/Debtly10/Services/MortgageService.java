...
public class MortgageService {
    ...
    public String addMortgage(MortgageRegistrationDTO mortgageRegistrationDTO, Long id) {
        ...
        if(mortgage.getGivenAmount()==-1 ||  mortgage.getLastPaid() == null || mortgage.getIssueDate() == null ||
                mortgage.getLeftAmount() == -1 || mortgage.getProductName() == null || mortgage.getMarketValue()==-1 ||
        mortgage.getInterestRate()==-1)
